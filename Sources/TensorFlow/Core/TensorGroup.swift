...
public protocol TensorGroup: TensorArrayProtocol {
    ...
    // TODO: This is a protocol requirement so that conformances can provide custom const-evaluable 
    // implementations. When the const-evaluator is powerful enough to evaluate the default
    // implementation, remove this requirement.

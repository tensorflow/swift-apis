...
public struct SequentialComposition<Base: Collection>: Layer
where
  Base: EuclideanDifferentiable,
  Base.Element: Layer,
  Base.TangentVector: ElementaryFunctions,
  Base.TangentVector: PointwiseMultiplicative,
  Base.TangentVector: VectorProtocol,
...
extension Collection where
  Self: EuclideanDifferentiable,
  Element: Layer,
  TangentVector: ElementaryFunctions,
  TangentVector: PointwiseMultiplicative,
  TangentVector: VectorProtocol,

...
![Diagram of the Swift compilation pipeline](./the-swift-compilation-pipeline.png)
...
<img src="./differentiation-control-flow.png" alt="Diagram of control flow in differentiation" width="40%" />

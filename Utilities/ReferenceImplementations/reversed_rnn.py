# Computes expected results for `testReversedRNN()` in `Tests/TensorFlowTests/LayerTests.swift`.
...
# Initialize the keras model with the SimpleRNN with backward direction.

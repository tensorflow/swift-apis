# Computes expected results for `testBidirectionalGRUSumMerge()` in `Tests/TensorFlowTests/LayerTests.swift`.
...
forward = tf.keras.layers.GRU(
    input_dim=input_dim, units=units,
...
initial_state_forward = tf.keras.Input(shape=[units])
initial_state_backward = tf.keras.Input(shape=[units])
...
update_kernel_forward = kernel_forward[:, :units]
update_recurrent_kernel_forward = recurrent_kernel_forward[:, :units]
reset_kernel_forward = kernel_forward[:, units: units * 2]
reset_recurrent_kernel_forward = recurrent_kernel_forward[:, units: units * 2]
new_kernel_forward = kernel_forward[:, units * 2:]
new_recurrent_kernel_forward = recurrent_kernel_forward[:, units * 2:]
update_bias_forward = bias_forward[0][:units]
update_recurrent_bias_forward = bias_forward[1][:units]
reset_bias_forward = bias_forward[0][units: units * 2]
reset_recurrent_bias_forward = bias_forward[1][units: units * 2]
new_bias_forward = bias_forward[0][units * 2:]
new_recurrent_bias_forward = bias_forward[1][units * 2:]

update_kernel_backward = kernel_backward[:, :units]
update_recurrent_kernel_backward = recurrent_kernel_backward[:, :units]
reset_kernel_backward = kernel_backward[:, units: units * 2]
reset_recurrent_kernel_backward = recurrent_kernel_backward[:, units: units * 2]
new_kernel_backward = kernel_backward[:, units * 2:]
new_recurrent_kernel_backward = recurrent_kernel_backward[:, units * 2:]
update_bias_backward = bias_backward[0][:units]
update_recurrent_bias_backward = bias_backward[1][:units]
reset_bias_backward = bias_backward[0][units: units * 2]
reset_recurrent_bias_backward = bias_backward[1][units: units * 2]
new_bias_backward = bias_backward[0][units * 2:]
new_recurrent_bias_backward = bias_backward[1][units * 2:]
...
grad_update_kernel_forward = grad_kernel_forward[:, :units]
grad_update_recurrent_kernel_forward = grad_recurrent_kernel_forward[:, :units]
grad_reset_kernel_forward = grad_kernel_forward[:, units: units * 2]
grad_reset_recurrent_kernel_forward = grad_recurrent_kernel_forward[:, units: units * 2]
grad_new_kernel_forward = grad_kernel_forward[:, units * 2:]
grad_new_recurrent_kernel_forward = grad_recurrent_kernel_forward[:, units * 2:]
grad_update_bias_forward = grad_bias_forward[0][:units]
grad_update_recurrent_bias_forward = grad_bias_forward[1][:units]
grad_reset_bias_forward = grad_bias_forward[0][units: units * 2]
grad_reset_recurrent_bias_forward = grad_bias_forward[1][units: units * 2]
grad_new_bias_forward = grad_bias_forward[0][units * 2:]
grad_new_recurrent_bias_forward = grad_bias_forward[1][units * 2:]

grad_update_kernel_backward = grad_kernel_backward[:, :units]
grad_update_recurrent_kernel_backward = grad_recurrent_kernel_backward[:, :units]
grad_reset_kernel_backward = grad_kernel_backward[:, units: units * 2]
grad_reset_recurrent_kernel_backward = grad_recurrent_kernel_backward[:, units: units * 2]
grad_new_kernel_backward = grad_kernel_backward[:, units * 2:]
grad_new_recurrent_kernel_backward = grad_recurrent_kernel_backward[:, units * 2:]
grad_update_bias_backward = grad_bias_backward[0][:units]
grad_update_recurrent_bias_backward = grad_bias_backward[1][:units]
grad_reset_bias_backward = grad_bias_backward[0][units: units * 2]
grad_reset_recurrent_bias_backward = grad_bias_backward[1][units: units * 2]
grad_new_bias_backward = grad_bias_backward[0][units * 2:]
grad_new_recurrent_bias_backward = grad_bias_backward[1][units * 2:]
